$(function(){
                ...
                success: function(res){
                    ...
                    $("#sizelist .img,#sizelist .img-opt").each(function(){
                        ...
                        if($this.hasClass("img")){
                            filePath = 'files/'+dirname+'/original/'+imgname+".png";
                        }else{
                            filePath = 'files/'+dirname+'/'+currentQuality+'/'+imgname+".png";
                        }
    ...
    $(".sava-size").on("click",function(){
        ...
        var url = g_editIndex < 0 ? '/addnewsize':'/sizemodify';
        var valied = true;
        ...
        if(isDone && dirname){
            loading.show();
             $.ajax({
                ...
                success: function(res){
                    loading.hide();
                    var url =  window.location.origin+'/files/'+dirname+'/'+pname+'.zip';
